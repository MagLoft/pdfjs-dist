...
var Font = function FontClosure() {
  ...
  Font.prototype = {
    ...
    getFontProps: function Font_getFontProps() {
      ...
      var nonStdFontMap = (0, _standard_fonts.getNonStdFontMap)();
      fontName = stdFontMap[fontName] || nonStdFontMap[fontName] || fontName;
      var bold = fontName.search(/bold/gi) !== -1;
      var italic = fontName.search(/oblique/gi) !== -1 || fontName.search(/italic/gi) !== -1;
      var black = name.search(/Black/g) !== -1;
      return {
